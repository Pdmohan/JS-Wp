/*
 $ @Author: 陌寒
 $ @Date: 2025-08-31 16:36:28
 $ @LastEditTime: 2025-08-31 16:36:45
...
Sakura.prototype.draw = function (cxt) {
    cxt.save(); var xc = 5 * this.s / 5; cxt.translate(this.x, this.y); cxt.rotate(this.r); cxt.drawImage(img, 0, 0, 25 * this.s, 30 * this.s)
    cxt.restore();
}
